...
console.log("𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙸𝙽𝙶 𝙿𝙰𝚈𝙾𝙴𝙱𝙾𝙸 𝙼𝙳 🎭...");
...
console.log('𝙿𝙰𝚈𝙾𝙴𝙱𝙾𝙸 𝙼𝙳 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 𝚃𝙾 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙴𝙽𝙹𝙾𝚈 ✅')

let up = ` ʙᴏᴛ⇨⇨ Connected Successfully!!!!!!* ✅ 

 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴘᴀʏᴏᴇʙᴏɪ xᴍᴅ
...
conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/kkpy93.jpg` }, caption: up })
...
app.get("/", (req, res) => {
res.send("𝙿𝙰𝚈𝙾𝙴𝙱𝙾𝙸 𝙼𝙳 is 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 ✅");
});
app.listen(port, () => console.log(`𝙿𝙰𝚈𝙾𝙴𝙱𝙾𝙸 𝙼𝙳 Server listening on port http://localhost:${port}`));
setTimeout(() => {
connectToWA()
}, 4000);
