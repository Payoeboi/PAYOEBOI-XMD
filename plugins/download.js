        ...
        if (_0x33bcb9 === '1') {
          ...
          if (_0x33bcb9 === '2') {
            await _0xd77fff.sendMessage(_0x41d115, {
              ...
              'caption': "*© Gᴇɴᴇʀᴀᴛᴇᴅ Bʏ ᴘᴀʏᴏᴇʙᴏɪ xᴍᴅ*"
            }, {
              'quoted': _0x58803e
            });
          } else if (_0x33bcb9 === '3') {
      ...
      if (_0x58b051) {
        ...
        if (_0x48db83 === "1.1") {
          await _0x1ac136.sendMessage(_0x231677, {
            ...
            'caption': "*© ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴘᴀʏᴏᴇʙᴏɪ xᴍᴅ*"
          }, {
            'quoted': _0x5ded0a
          });
        } else {
      ...
      if (_0x4dbcb0) {
        ...
        if (_0x1e75d9 === "1.1") {
          await _0xaf8db8.sendMessage(_0x5eb615, {
            ...
            'caption': "*© Gᴇɴʀᴇʀᴀᴛᴇᴅ Bʏ ᴘᴀʏᴏᴇʙᴏɪ*"
          }, {
            'quoted': _0x2405c0
          });
        } else {
